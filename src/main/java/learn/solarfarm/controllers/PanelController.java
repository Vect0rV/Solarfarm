...
public class PanelController {
    ...
    @PostMapping
    public ResponseEntity<Object> add(@RequestBody Panel panel) throws DataAccessException {
    ...
    @PutMapping("/{panelId}")
    public ResponseEntity<Object> update(@PathVariable("panelId") int panelId,@RequestBody Panel panel) throws DataAccessException {
