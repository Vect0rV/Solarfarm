...
public class AppUser implements UserDetails {
    ...
    public AppUser(int appUserId, String username, String password, boolean enabled, List<String> roles) {
        this(appUserId, username, password, enabled, convertRoleToAuthorities(roles));
    }

    public static Collection<GrantedAuthority> convertRoleToAuthorities(List<String> roles) {
        return roles.stream()
